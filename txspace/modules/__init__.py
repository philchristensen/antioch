...
__path__ = [os.path.abspath(os.path.join(x, 'txspace', 'modules')) for x in sys.path]

__all__ = []

def iterate():
	import txspace.modules
	for module in plugin.getPlugins(IModule, txspace.modules):
		yield module()
