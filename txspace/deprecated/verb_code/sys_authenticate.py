...
if(username == 'guest'):
	...
	if(system.has_readable_property('guestbook')):
		...
		guestbook = {}
		system.add_property('guestbook', guestbook, owner=owner)
	...
	for name in guest_names:
		if(name in guestbook):
			...
			guest_object.set_owner(owner)
			allow(guest_object, 'set_observing', guest_object)
