...
#
# $Id: wizard_load.py 184 2007-03-04 18:54:05Z phil $
#
...
if not(has_dobj_str()):
	caller.write("What verb do you want to load?")
	return
if not(has_pobj_str('on')):
	caller.write("On what object should that verb be defined?")
	return
if not(has_pobj_str('with')):
	caller.write("With what path should should we load the verb?")
	return
